...
<link rel="stylesheet" href="<?= base_url('assets/adminlte3') ?>/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css">
...
<script src="<?= base_url('assets/adminlte3') ?>/plugins/inputmask/jquery.inputmask.min.js"></script>
<!-- date-range-picker -->
