...
<?= $this->section('head') ?>
<!-- Ion Slider -->
<link rel="stylesheet" href="<?= base_url('assets/adminlte3') ?>/plugins/ion-rangeslider/css/ion.rangeSlider.min.css">
<!-- bootstrap slider -->
<link rel="stylesheet" href="<?= base_url('assets/adminlte3') ?>/plugins/bootstrap-slider/css/bootstrap-slider.min.css">
<?= $this->endSection() ?>
